...
BUCKET_NAME = "hw4-project-d79af39f-8a71-4f5d-812"
...
combinations = list(itertools.product(COLORS, YEARS, MONTHS))
arg_colors, arg_years, arg_months = zip(*combinations)
...
if __name__ == "__main__":
    ...
    with ThreadPoolExecutor(max_workers=4) as executor:
        file_paths = list(
            executor.map(download_file, arg_colors, arg_years, arg_months)
        )
